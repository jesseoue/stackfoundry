...
1. Added SaaS recipes, readiness statuses, and stricter validation for complete product workflows.
...
6. Added `agent-ready-installs` with prompt packs and context files for coding assistants.
