...
description: Maintain the Cloudflare Workers vendor registry block installed by StackFoundry.
---
...
This block owns the Cloudflare Workers integration example only. Keep product-specific business logic outside the vendor adapter until the app has chosen this provider.
