...
Blog and product changelog list pages with release notes helpers.

## Owns

- `apps/web/src/lib/blog-changelog.ts`
...
- Verify with `stackfoundry add blog-changelog --target <app> --dry-run`.
