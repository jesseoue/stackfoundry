...
export default function BlogChangelogPage() {
  return (
    <main className="flex flex-col gap-6 p-6">
      <div>
        <h1 className="text-2xl font-semibold">Blog Changelog</h1>
        <p className="text-muted-foreground">Blog and product changelog list pages with release notes helpers.</p>
      </div>
