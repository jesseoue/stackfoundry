...
export default function BillingCorePage() {
  return (
    <main className="flex flex-col gap-6 p-6">
      <div>
        <h1 className="text-2xl font-semibold">Billing Core</h1>
        <p className="text-muted-foreground">Provider-neutral customer, plan, and subscription primitives.</p>
      </div>
