...
Plan comparison page with feature groups and call-to-action slots.

## Owns

- `apps/web/src/lib/pricing-page.ts`
...
- Verify with `stackfoundry add pricing-page --target <app> --dry-run`.
