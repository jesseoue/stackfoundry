...
export default function DunningRecoveryPage() {
  return (
    <main className="flex flex-col gap-6 p-6">
      <div>
        <h1 className="text-2xl font-semibold">Dunning Recovery</h1>
        <p className="text-muted-foreground">Failed payment recovery sequence with email and in-app notices.</p>
      </div>
