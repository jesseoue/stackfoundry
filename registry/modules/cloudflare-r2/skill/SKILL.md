---
name: cloudflare-r2
description: Maintain the Cloudflare R2 vendor registry block installed by StackFoundry.
---
...
This block owns the Cloudflare R2 integration example only. Keep product-specific business logic outside the vendor adapter until the app has chosen this provider.
