...
export default function PublicApiOrpcPage() {
  return (
    <main className="flex flex-col gap-6 p-6">
      <div>
        <h1 className="text-2xl font-semibold">Public API</h1>
        <p className="text-muted-foreground">Versioned API response helpers, errors, and pagination primitives.</p>
      </div>
