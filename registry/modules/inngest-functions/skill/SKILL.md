...
description: Maintain the Inngest Functions vendor registry block installed by StackFoundry.
---
...
This block owns the Inngest Functions integration example only. Keep product-specific business logic outside the vendor adapter until the app has chosen this provider.
