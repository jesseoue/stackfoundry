...
export default function LifecycleEmailPage() {
  return (
    <main className="flex flex-col gap-6 p-6">
      <div>
        <h1 className="text-2xl font-semibold">Lifecycle Email</h1>
        <p className="text-muted-foreground">Lifecycle email campaign definitions, audience rules, and delivery checklist.</p>
      </div>
