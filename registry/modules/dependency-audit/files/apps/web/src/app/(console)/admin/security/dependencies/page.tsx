...
export default function DependencyAuditPage() {
  return (
    <main className="flex flex-col gap-6 p-6">
      <div>
        <h1 className="text-2xl font-semibold">Dependency Audit</h1>
        <p className="text-muted-foreground">Dependency scanning, high-severity gate, and release checklist.</p>
      </div>
